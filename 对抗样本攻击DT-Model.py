...
def main():
    ...
    prec_adv = precision_score(y_test_attacked, y_pred_adv, average='macro', zero_division=0)
    rec_adv = recall_score(y_test_attacked, y_pred_adv, average='macro', zero_division=0)
    f1_adv = f1_score(y_test_attacked, y_pred_adv, average='macro', zero_division=0)
